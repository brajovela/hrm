                ...
                <div class="navbar-right">
                        ...
                        <?php if($user->user_level == "Admin"){?>
                        	<li class="dropdown messages-menu">
	                            ...
	                            <ul class="dropdown-menu">
	                                    <li>
	                                    	<a href="#" onclick="modJs.showMessage('About','<p>ForEach Hrm - Human Resource Management<br/>Version 9.0<br/>Release Date: 2015/02/12<br/>Support: soporte@4ich.com</p>')"><h5>About</h5></a>
	                                    </li>
	                             </ul>
	                        </li>
	                    <?php }?>
